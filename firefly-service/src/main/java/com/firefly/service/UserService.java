...
import com.firefly.dao.UserDao;
import com.firefly.domain.PageResult;
import com.firefly.domain.RefreshTokenDetail;
...
//        elasticSearchService.addUserInfo(userInfo);
    ...
    public String login(User user) throws Exception{
        ...
        //登录时取出该盐，按同样规则再算一次MD5值，进行加密密码比对
    ...
    public Map<String, Object> loginForDts(User user) throws Exception{
        ...
        //accessToken与refreshToken的区别只在于有效期
        //1h —— 7days
        String accessToken = TokenUtil.generateToken(userId);
        String refreshToken = TokenUtil.generateRefreshToken(userId);
        //保存refresh token到数据库:删旧存新
